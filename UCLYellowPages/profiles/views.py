...
import re
from django.forms import CustomUserCreationForm, UserDataForm
...
def profile_view(request, username):
    ...
    # Track profile view
    if profile.track_profile_views and request.user != user and request.user.is_authenticated:
